...
import UIKit
class DaTiKaViewController:UIViewController{
    ...
    //声明闭包属性
    var closure: Closure!
    var mController:PracticeSubjectsViewController!
    var mIndex:Int!
    ...
    public func setController(controller:PracticeSubjectsViewController){
