...
import UIKit
class WrongDaTiKaViewController:UIViewController{
    ...
    //声明闭包属性
    var closure: Closure!
    var mController:WrongSubjectsViewController!
    var mIndex:Int!
    var mAllTiMuIds = [Int]()
    ...
    public func setController(controller:WrongSubjectsViewController){
    ...
    func setBoxView(){
        ...
        if((mTiMuData[mIndex]["daan_state"] as? Int)==0){
            button.backgroundColor = UIColor.gray
        }else{
            if((mTiMuData[mIndex]["cuoti_lxState"] as? Int)==0){
        ...
        button.setTitle(String(mTiMuXuHao), for: UIControlState.normal)
