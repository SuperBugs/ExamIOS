...
class PracticeSubjectsViewController:UIViewController{
    ...
    public func setDanXuanTiView(tiMuDataId:Int){
        ...
        if((mTiMuData[tiMuDataId]["daan_state"] as! Int)==0){
            
        }else{
            var result=false
            var height:CGFloat!
            var height1=CGFloat(0)//题目解析高度
            let data=mTiMuData[tiMuDataId]
            if(String(describing: mTiMuData[container.tag]["class_timu"]!)=="单选题"){
                height=CGFloat(container.subviews[3].tag)
                if let userDaan = data["userdaan_lx"] as? String{
                    if let rightDaan = data["daan"] as? String{
            ...
            if  let jieXi = data["jiexi"] as? String{
                ...
                container.addSubview(textView3)
            }
            ...
            container.contentSize = CGSize(width: mDimen.mScreenW, height: height+height1+200)
            
            if((mTiMuData[container.tag]["userdaan_lx"] as? String)=="A"){
                imageView1.tag = 1
                imageView1.image=UIImage(named:"select_yuan")
                container.insertSubview(imageView1, at: 4)
            }
            if((mTiMuData[container.tag]["userdaan_lx"] as? String)=="B"){
                imageView2.tag = 1
                imageView2.image=UIImage(named:"select_yuan")
                container.insertSubview(imageView2, at: 5)
            }
            if((mTiMuData[container.tag]["userdaan_lx"] as? String)=="C"){
                imageView3.tag = 1
                imageView3.image=UIImage(named:"select_yuan")
                container.insertSubview(imageView3, at: 6)
            }
            if((mTiMuData[container.tag]["userdaan_lx"] as? String)=="D"){
                imageView4.tag = 1
    ...
    public func setPanDuanTiView(tiMuDataId:Int){
        ...
        if((mTiMuData[tiMuDataId]["daan_state"] as! Int)==0){
            ...
            var height1=CGFloat(0)//题目解析高度
            let data=mTiMuData[tiMuDataId]
            if(String(describing: mTiMuData[container.tag]["class_timu"]!)=="判断题"){
                height=CGFloat(container.subviews[1].tag)
            ...
            container.addSubview(textView2)
            container.contentSize = CGSize(width: mDimen.mScreenW, height: height+height1+200)
            if((mTiMuData[container.tag]["userdaan_lx"] as? String)=="正确"){
                imageView1.tag = 1
                imageView1.image=UIImage(named:"select_yuan")
                container.insertSubview(imageView1, at: 2)
            }
            if((mTiMuData[container.tag]["userdaan_lx"] as? String)=="错误"){
                imageView2.tag = 1
                imageView2.image=UIImage(named:"select_yuan")
    ...
    public func setDuoXuanTiView(tiMuDataId:Int){
        ...
        if((mTiMuData[tiMuDataId]["daan_state"] as! Int)==0){
            ...
            if(String(describing: mTiMuData[container.tag]["class_timu"]!)=="多选题"){
                height=CGFloat(container.subviews[3].tag)
                if let userDaan = data["userdaan_lx"] as? String{
                    if let rightDaan = data["daan"] as? String{
                        if(userDaan==rightDaan){
            ...
            if((mTiMuData[container.tag]["userdaan_lx"] as! String).contains("A")){
                imageView1.tag = 1
                imageView1.image=UIImage(named:"select_yuan")
                container.insertSubview(imageView1, at: 4)
            }
            if((mTiMuData[container.tag]["userdaan_lx"] as! String).contains("B")){
                imageView2.tag = 1
                imageView2.image=UIImage(named:"select_yuan")
                container.insertSubview(imageView2, at: 5)
            }
            if((mTiMuData[container.tag]["userdaan_lx"] as! String).contains("C")){
                imageView3.tag = 1
                imageView3.image=UIImage(named:"select_yuan")
                container.insertSubview(imageView3, at: 6)
            }
            if((mTiMuData[container.tag]["userdaan_lx"] as! String).contains("D")){
                imageView4.tag = 1
                imageView4.image=UIImage(named:"select_yuan")
                container.insertSubview(imageView4, at: 7)
            }
            if((mTiMuData[container.tag]["userdaan_lx"] as! String).contains("E")){
                imageView5.tag = 1
                imageView5.image=UIImage(named:"select_yuan")
                container.insertSubview(imageView5, at: 9)
            }
            if((mTiMuData[container.tag]["userdaan_lx"] as! String).contains("F")){
                imageView6.tag = 1
    ...
    @objc func bottomCheckAnswer() {
        ...
        if(!result){
            ...
            if(!wrongTiMus.contains(tiMuId)){
                ...
                print("\(mShiJuanData["class_kemu"] as! String)wrong")
            }
        }
    }
    ///收藏题目点击事件
    ...
    @objc func toDaTiKa(){
        ...
        let daTiKaC=DaTiKaViewController()
...
extension PracticeSubjectsViewController: UIScrollViewDelegate {
        ...
        if(page<0||page>mTiMuIds.count-1){
            ...
            if(String(describing: mTiMuData[contioner1.tag]["class_timu"]!)=="多选题"&&(contioner1.subviews.count<=14)){
                ...
                if(!result){
                    ...
                    var wrongTiMus=[Int]()
                    let tiMuId=mTiMuIds[contioner.tag]//题目ID
                    if let wrongTiMu = CommonFunction.getNormalDefult(key: "\(String(describing: mShiJuanData["class_kemu"]))wrong") as? [Int]{
                        wrongTiMus=wrongTiMu
                    }
                    if(!wrongTiMus.contains(tiMuId)){
                        mCollectTiMuIds.append(tiMuId)
                        CommonFunction.setNormalDefault(key: "\(String(describing: mShiJuanData["class_kemu"]))wrong", value: mCollectTiMuIds as AnyObject)
                    }
