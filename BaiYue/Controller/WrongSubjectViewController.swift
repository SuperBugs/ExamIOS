...
import UIKit
class WrongSubjectViewController:UIViewController{
    ...
    private func getWrongSubjectsData(){
        if let tiMuIds1=CommonFunction.getNormalDefult(key: "公共基础wrong") as? [Int]{
            mTiMuIds1=tiMuIds1
        }
        
        if let tiMuIds2=CommonFunction.getNormalDefult(key: "道路工程wrong") as? [Int]{
            mTiMuIds2=tiMuIds2
        }
        if let tiMuIds3=CommonFunction.getNormalDefult(key: "桥梁隧道工程wrong") as? [Int]{
            mTiMuIds3=tiMuIds3
        }
        if let tiMuIds4=CommonFunction.getNormalDefult(key: "交通工程wrong") as? [Int]{
            mTiMuIds4=tiMuIds4
        }
    ...
    private func setupViews(){
        ...
        button1.setTitle("公共基础 答错\(mTiMuIds1.count)题", for: UIControlState.normal)//设置按钮标题
        ...
        button2.setTitle("道路工程 答错\(mTiMuIds2.count)题", for: UIControlState.normal)//设置按钮标题
        ...
        button3.setTitle("桥梁隧道工程 答错\(mTiMuIds3.count)题", for: UIControlState.normal)//设置按钮标题
        ...
        button4.setTitle("交通工程 答错\(mTiMuIds4.count)题", for: UIControlState.normal)//设置按钮标题
    ...
    @objc func btnClick(sender:UIButton?) {
        ...
        case 1:
            if(mTiMuIds1.count>0){
                ...
                let controller=UserWrongSubjectsViewController()
