...
import UIKit
class UserWrongDaTiKaViewController:UIViewController{
    ...
    //声明闭包属性
    var closure: Closure!
    var mController:UserWrongSubjectsViewController!
    var mIndex:Int!
    ...
    public func setController(controller:UserWrongSubjectsViewController){
